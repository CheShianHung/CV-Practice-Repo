...
for imagePath in imagePaths:
  ...
  # threshold the images with white digits as foreground against black background
  ...
  for c in cnts:
    ...
    pred = model.predict(roi).argmax(axis=1)[0] + 1 # we add 1 since there is no class 0, only 1 to 9
